...
__decorate([
    (0, common_1.Post)('image-from-url'),
    (0, swagger_1.ApiOperation)({ summary: 'Upload an image from URL to Cloudinary' }),
    (0, swagger_1.ApiBody)({
...
], CloudinaryController.prototype, "uploadImageFromUrl", null);
exports.CloudinaryController = CloudinaryController = __decorate([
    (0, swagger_1.ApiTags)('upload'),
    (0, common_1.Controller)('upload'),
    __metadata("design:paramtypes", [upload_service_1.CloudinaryService])
